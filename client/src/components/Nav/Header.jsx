                    ...
                    <div className="w-full max-w-7xl px-4">
                        <div className="grid grid-cols-6  items-center h-16">
                            ...
                            <div className="col-span-3 md:flex items-center  justify-start  space-x-8">
                                ...
                                <a href="#" className="text-black hover:text-gray-700 font-bold">SHOP</a>
                            ...
                            <div className="flex  col-span-2 items-center justify-end space-x-4">
                                ...
                                <a href="/auth/login" className="px-4 py-2 text-black hover:text-gray-700 font-bold">LOG IN</a>
                                <a href="/auth/signup" className="px-4 py-2 bg-black text-white rounded hover:bg-gray-800 font-bold">SIGN UP</a>
                            </div>
                        </div>
                    </div>
                </nav>
